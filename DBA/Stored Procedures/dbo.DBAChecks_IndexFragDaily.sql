...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[DBAChecks_IndexFragDaily](@HTML varchar(max) out)
AS
/* 
...
DROP TABLE #dbindex
GO
GRANT ALTER ON  [dbo].[DBAChecks_IndexFragDaily] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[DBAChecks_IndexFragDaily] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[DBAChecks_IndexFragDaily] TO [db_sp_viewer]
GO
