...
CREATE PROCEDURE [dbo].[usp_bpcheck]
...
GO
GRANT ALTER ON  [dbo].[usp_bpcheck] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[usp_bpcheck] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[usp_bpcheck] TO [db_sp_viewer]
GO
