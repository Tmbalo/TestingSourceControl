...
END;
GO
GRANT ALTER ON  [dbo].[sp_WhoIsActive] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[sp_WhoIsActive] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[sp_WhoIsActive] TO [db_sp_viewer]
GO
