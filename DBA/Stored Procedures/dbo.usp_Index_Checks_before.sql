...
CREATE PROC [dbo].[usp_Index_Checks_before]
as
...
<h1>Index Checks Report for ' + @@SERVERNAME + '</h1>
'
...
GO
GRANT ALTER ON  [dbo].[usp_Index_Checks_before] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[usp_Index_Checks_before] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[usp_Index_Checks_before] TO [db_sp_viewer]
GO
