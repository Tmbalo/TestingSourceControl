...
CREATE PROCEDURE [dbo].[Alert_Blocking]
    @BlockingDurationThreshold smallint = 30,
    @BlockedSessionThreshold smallint = NULL,
    @EmailRecipients varchar(max) = 'Thozamile.Mbalo@westerncape.gov.za;Pierre.Dane@westerncape.gov.za',
...
END;
GO
GRANT ALTER ON  [dbo].[Alert_Blocking] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[Alert_Blocking] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[Alert_Blocking] TO [db_sp_viewer]
GO
