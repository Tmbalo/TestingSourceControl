...
CREATE PROC [dbo].[usp_Index_Check_After] (
...
set @subject = 'Index Check After Rebuild (' + @@SERVERNAME + ')'
...
GO
GRANT ALTER ON  [dbo].[usp_Index_Check_After] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[usp_Index_Check_After] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[usp_Index_Check_After] TO [db_sp_viewer]
GO
