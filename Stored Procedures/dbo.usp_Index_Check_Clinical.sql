...
CREATE PROC [dbo].[usp_Index_Check_Clinical] (
...
--exec [dbo].[DBAChecks_IndexFragDaily_After] @HTML=@IndexFrag out

exec [dbo].[DBAChecks_IndexFragDaily_AFTER_Clinical] @HTML=@IndexFrag out
...
set @subject = 'Index Check After Rebuild For Clinical (' + @@SERVERNAME + ')'
...
GO
GRANT ALTER ON  [dbo].[usp_Index_Check_Clinical] TO [db_sp_alter]
GO
GRANT EXECUTE ON  [dbo].[usp_Index_Check_Clinical] TO [db_sp_executor]
GO
GRANT VIEW DEFINITION ON  [dbo].[usp_Index_Check_Clinical] TO [db_sp_viewer]
GO
